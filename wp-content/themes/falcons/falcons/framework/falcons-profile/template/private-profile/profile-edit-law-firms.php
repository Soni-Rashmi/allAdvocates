              ...
              <div class="portlet light">
                <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      <span class="caption-subject"> <?php esc_html_e('Edit '.$directory_url_1_string,'falcons'); ?></span>
                    </div>
					  ...
					  <?php					
						...
						if ( $post_edit->post_author != $current_user->ID or $have_edit_access=='no') {
							...
							<?php esc_html_e('Please ','falcons'); ?>
							 <a href="<?php echo $reg_page.'?&profile=level'; ?>" title="Upgarde"><b><?php esc_html_e('Login or upgrade ','falcons'); ?> </b></a> 
					...
					?>					
						...
						<div class="row">
							...
							<form action="" id="edit_post" name="edit_post"  method="POST" role="form">
								...
								<label for="text" class=" control-label"><?php esc_html_e($directory_url_1_string.' Name','falcons'); ?></label>
									<div class="  "> 
										<input type="text" class="" name="title" id="title"  placeholder="<?php esc_html_e('Enter name here','falcons'); ?>" value="<?php echo $title;?>">
									</div>																		
								</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group ">
												...
												<label for="text" class=" control-label"><?php esc_html_e('Logo','falcons'); ?>  </label>
													<?php
													...
													<div class="" id="logo_image_edit">	
														<button type="button" onclick="logo_post_image('logo_image_div');"  class="btn btn-sm green-haze"><?php esc_html_e('Add','falcons'); ?> </button>
										...
										<div class="col-md-6">
											<div class="form-group ">
												<label for="text" class="control-label"><?php esc_html_e('Feature Image','falcons'); ?>  </label>
													...
													<div class="" id="post_image_edit">	
														<button type="button" onclick="edit_post_image('post_image_div');"  class="btn btn-sm green-haze"><?php esc_html_e('Add','falcons'); ?> </button>
								...
								<div class=" row form-group ">
									<label for="text" class=" col-md-5 control-label"><?php esc_html_e('Image Gallery','falcons'); ?> 
										<button type="button" onclick="edit_gallery_image('gallery_image_div');"  class="btn btn-sm green-haze"><?php esc_html_e('Add Images','falcons'); ?></button>
									 </label>						
								</div>
								<div class=" row form-group ">	
											<!--
								...
								<div id="collapseFour" class="panel-collapse collapse">
								  <div class="panel-body">											
									...
									<div class=" form-group">
											...
											<div class="  "> 
												<input type="text" class="" name="contact_web" id="contact_web" value="<?php echo get_post_meta($post_edit->ID,'contact_web',true); ?>" placeholder="<?php esc_html_e('Enter Full Web Address','falcons'); ?>">
											</div>																
									</div>
								...
								<div class="panel-heading">
								  <h4 class="panel-title col-lg-10">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapsethirtysix">
									  <?php esc_html_e('Our '.$directory_url_2,'falcons'); ?>
									</a>
								  </h4>
									<h4 class="panel-title" style="text-align:right;color:#1AA2E1;font-size:12px;">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapsethirtysix">
								  ...
								  <div class="panel-body">	
									  <?php
													...
													<div class=" form-group">
														<div class=""> 
															<select name="physician_list[]" id="physician_list[]" size="20" multiple="multiple"  class="">
																<?php
																foreach ( $cpt2s as $row_cpt2 )								
																{
																	$selected='';
																	if($physician_list!=''){
																		if (in_array($row_cpt2->ID,$physician_list)) {
																		$selected='selected';
																		}
																	}
																?>																	
																	<option value="<?php echo $row_cpt2->ID; ?>" <?php echo $selected;?> ><?php echo $row_cpt2->post_title; ?></option>
										...
										<?php
												...
												_e('Please upgrade your account to add  '.$directory_url_2,'falcons');
										}
										?>
					...
					<div class="panel panel-default">
								...
								<div id="collapseSix" class="panel-collapse collapse">
								  <div class="panel-body">											
										...
										?>		
										<div class=" form-group">
											<label for="text" class=" control-label"><?php esc_html_e('Event Title','falcons'); ?></label>
												<input type="text" class="" name="event-title" id="event-title" value="<?php echo get_post_meta($post_edit->ID,'event_title',true); ?>" placeholder="<?php esc_html_e('Enter Title Here','falcons'); ?>">							
										</div>	
										<div class=" form-group">
											<label for="text" class=" control-label"><?php esc_html_e('Event Detail','falcons'); ?></label>
												<?php
													$settings_a = array(															
														'textarea_rows' =>10,	
														'editor_class' => ''															 
										...
										<div class=" row form-group " style="margin-top:10px">
											<label for="text" class=" col-md-5 control-label"><?php esc_html_e('Event Image','falcons'); ?>  </label>
											...
											<div class="col-md-3" id="event_image_edit">	
													...
													<?php		
															...
															<button type="button" onclick="event_post_image('event_image_div');"  class="btn btn-xs green-haze"><?php esc_html_e('Add','falcons'); ?></button>
													<?php
													}
													?>		
											</div>	
										...
										<?php
												...
												_e('Please upgrade your account to add event ','falcons');
										}
										?>
								  </div>
...
function iv_update_post (){
	...
	var loader_image = '<img src="<?php echo wp_iv_directories_URLPATH. "admin/files/images/loader.gif"; ?>" />';
				...
				var search_params={
					"action"  : 	"iv_directories_update_cpt1",	
