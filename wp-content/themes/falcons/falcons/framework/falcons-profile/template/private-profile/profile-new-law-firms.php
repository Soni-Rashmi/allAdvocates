              ...
              <div class="portlet light">
                <div class="portlet-title tabbable-line clearfix">
                    <div class="caption caption-md">
                      <span class="caption-subject"> <?php esc_html_e('New '.$directory_url_1_string,'falcons'); ?></span>
                    </div>
						...
						<div class="row">
							...
							<form action="" id="new_post" name="new_post"  method="POST" role="form">
								<div class=" form-group">
									...
									<div class="  "> 
										<input type="text" class="" name="title" id="title" value="" placeholder="<?php esc_html_e('Enter name here','falcons'); ?>">
									</div>																		
								</div>
								...
								<div class=" row form-group ">
									<label for="text" class=" col-md-5 control-label"><?php esc_html_e('Image Gallery','falcons'); ?> 
										<button type="button" onclick="edit_gallery_image('gallery_image_div');"  class="btn btn-xs green-haze"><?php esc_html_e('Add Images','falcons'); ?></button>
									 </label>						
								</div>
								<div class=" row form-group ">	
											<!--
								...
								<div id="collapseFour" class="panel-collapse collapse">
								  <div class="panel-body">											
									...
									<div class=" form-group">
											...
											<div class="  "> 
												<input type="text" class="" name="contact_web" id="contact_web" value="" placeholder="<?php esc_html_e('Enter Full Web Address','falcons'); ?>">
											</div>																
									</div>
								  ...
								  <div class="panel-body">	
									...
									<div class=" row  form-group ">
										...
										<?php
												...
												esc_html_e('Please upgrade your account to add Award ','falcons');
										}
										?>
									  ...
									  <?php
										 ...
										 if($this->check_write_access('lawyer')){
												...
												if(sizeof($total_post)>0){
													...
													?>										
													<div class=" form-group">												
														<label for="text" class=" control-label"><?php esc_html_e('Our '.$directory_url_2,'falcons'); ?></label>
														...
														<div class=""> 
															<select name="physician_list[]" id="physician_list[]" size="20" multiple="multiple"  class="">
																...
																{
																?>																	
																	<option value="<?php echo $row_cpt2->ID; ?>" ><?php echo $row_cpt2->post_title; ?></option>
								  ...
								  <div class="panel-body">	
									  <?php
										...
										<?php
												...
												esc_html_e('Please upgrade your account to add video ','falcons');
										}
										?>
								  ...
								  <div class="panel-body">											
										...
										<div class=" form-group">
											<label for="text" class=" control-label"><?php esc_html_e('Event Title','falcons'); ?></label>
												<input type="text" class="" name="event-title" id="event-title" value="" placeholder="<?php esc_html_e('Enter Title Here','falcons'); ?>">							
										</div>	
										<div class=" form-group">
										...
										<?php
												...
												esc_html_e('Please upgrade your account to add event ','falcons');
										}
										?>
								  </div>
...
function iv_save_post (){
	...
	var loader_image = '<img src="<?php echo wp_iv_directories_URLPATH. "admin/files/images/loader.gif"; ?>" />';
				...
				var search_params={
					"action"  : 	"iv_directories_save_cpt1",	
